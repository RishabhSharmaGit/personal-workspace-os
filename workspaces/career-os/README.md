...
All personal input — raw source artifacts (resume PDFs, LinkedIn exports, job descriptions, IG/chat dumps) **and** sensitive structured data (current comp, ESOPs, vesting, comp targets, personal contacts) — lives outside this workspace in the repo-root `personal/` folder (gitignored). Sensitive structured data sits under `personal/private/`. See `personal/README.md` for the layout and naming convention.
